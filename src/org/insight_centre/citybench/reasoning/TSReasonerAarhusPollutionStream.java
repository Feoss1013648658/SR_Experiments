...
public class TSReasonerAarhusPollutionStream extends TSReasonerSensorStream implements Runnable {
	...
	public static void main(String[] args) {
		try {
			...
			TSReasonerAarhusPollutionStream aps = new TSReasonerAarhusPollutionStream("testuri",
	...
	public TSReasonerAarhusPollutionStream(String uri, String txtFile, EventDeclaration ed) throws IOException {
		super(uri);
	...
	public TSReasonerAarhusPollutionStream(String uri, String txtFile, EventDeclaration ed, Date start, Date end)
			throws IOException {
		super(uri);
