...
public abstract class TSReasonerSensorStream extends TripleStream implements Runnable {

	public TSReasonerSensorStream(String iri) {
		super(iri);
	...
	private static final Logger logger = LoggerFactory.getLogger(TSReasonerSensorStream.class);
	...
	public void stop() {
		if (!stop) {
			stop = true;
			logger.info("Stopping stream: " + this.getId());
		}
