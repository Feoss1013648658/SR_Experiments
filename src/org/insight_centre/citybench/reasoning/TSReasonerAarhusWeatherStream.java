...
public class TSReasonerAarhusWeatherStream extends TSReasonerSensorStream implements Runnable {
	...
	public TSReasonerAarhusWeatherStream(String uri, String txtFile, EventDeclaration ed) throws IOException {
		super(uri);
	...
	public TSReasonerAarhusWeatherStream(String uri, String txtFile, EventDeclaration ed, Date start, Date end)
			throws IOException {
		super(uri);
		streamData = new CsvReader(String.valueOf(txtFile));
		this.ed = ed;
