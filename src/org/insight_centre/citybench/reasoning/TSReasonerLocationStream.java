...
public class TSReasonerLocationStream extends TSReasonerSensorStream implements Runnable {
	private static final Logger logger = LoggerFactory.getLogger(TSReasonerLocationStream.class);
	private String txtFile;
	private EventDeclaration ed;

	// private ContextualFilteringManager cfm;

	public TSReasonerLocationStream(String uri, String txtFile, EventDeclaration ed) {
		super(uri);
